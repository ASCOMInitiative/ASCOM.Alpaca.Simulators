...
{
    public class JaggedArray2DResponse<T> : Response, IArrayResponse<T[][]>
    {
        ...
        //   value:
        //     Value to return
        public JaggedArray2DResponse(uint clientTransactionID, uint serverTransactionID, T[][] value)
        {
        ...
        //   errorCode:
        //     Server transaction ID
        public JaggedArray2DResponse(uint clientTransactionID, uint serverTransactionID, string errorMessage, AlpacaErrors errorCode)
        {
            base.ServerTransactionID = serverTransactionID;
            base.ClientTransactionID = clientTransactionID;
