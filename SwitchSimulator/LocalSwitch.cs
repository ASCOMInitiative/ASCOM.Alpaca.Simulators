...
namespace ASCOM.Simulators
{
    ...
    public class LocalSwitch
    {
        ...
        internal LocalSwitch(IProfile profile, int id)
        {
            var subKey = "Switch" + id.ToString();
            this.Name = profile.GetValue("Name " + subKey, subKey);
            this.Minimum = Convert.ToDouble(profile.GetValue("Minimum " + subKey, "0"), CultureInfo.InvariantCulture);
            this.Maximum = Convert.ToDouble(profile.GetValue("Maximum " + subKey, "1"), CultureInfo.InvariantCulture);
            this.StepSize = Convert.ToDouble(profile.GetValue("StepSize " + subKey, "1"), CultureInfo.InvariantCulture);
        ...
        internal void Save(IProfile profile, int id)
        {
            var subKey = "Switch" + id.ToString();
            profile.WriteValue("Name " + subKey, this.Name);
            profile.WriteValue("Description " + subKey, this.Description);
            profile.WriteValue("Minimum " + subKey, this.Minimum.ToString(CultureInfo.InvariantCulture));
            profile.WriteValue("Maximum " + subKey, this.Maximum.ToString(CultureInfo.InvariantCulture));
